(ns teis.ui.openlayers
  ...
  (:require [cljs.core.async :refer [<! >! chan timeout alts!] :as async]
            ...
            ;[teis.geo :as geo]
            ;[teis.style.base :as style-base]
            ;[teis.style.colors :as colors]
            ;[teis.ui.openlayers.featuret :refer [aseta-tyylit] :as featuret]
            [teis.ui.openlayers.geojson :as geojson]
            [teis.ui.openlayers.geometriataso]
            [teis.ui.openlayers.kuvataso :as kuvataso]
            [teis.ui.openlayers.mvt :as mvt]
            ;[teis.ui.openlayers.projektiot :refer [projektio suomen-extent]]
            [teis.ui.openlayers.taso :as taso]
            [teis.ui.openlayers.taustakartta :as taustakartta]
            [teis.ui.openlayers.tile :as tile]
...
(defmethod tuck.effect/process-effect :refresh-layer [_ {layer-name :layer}]
  (when-let [layer (some #(when (= (.get % "teis-layer-name") (name layer-name)) %)

...
(defn- asset-component-and-material-oids
...
(defn project-cost-groups-totals
  ...
  [db thk-project-id & [oids]]
    (let [items (cost-group-attrs-q
               db (if (some? oids)
                    oids
                    (asset-component-and-material-oids-of-project db thk-project-id)))
